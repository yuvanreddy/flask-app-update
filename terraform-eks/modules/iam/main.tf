# GitHub OIDC Provider (already exists in your account)
...
resource "aws_iam_role_policy" "github_deployer_eks_access" {
...
# Complete ALB Controller IAM Policy
